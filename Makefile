...
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -O2 -flto=22 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		sexy-music-player.pro  main.cpp
QMAKE_TARGET  = ssmp
DESTDIR       = 
TARGET        = ssmp
...
Makefile: sexy-music-player.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
